...
public:
    TripletBuffer() : buffer_{std::make_shared<Element>(), std::make_shared<Element>(), std::make_shared<Element>()}
    {
    }
...
private:
    std::shared_ptr<Element> buffer_[3];
